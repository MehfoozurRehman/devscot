...
export default function ProjectDetails() {
  ...
  const heading = splitText("Walking");
    ...
    <>
      ...
      <div className="project__details__container">
          ...
          <div className="project__details__text__header__container__left">
            ...
            <Fade up delay={100}>
              <div className="project__details__text__header__container__left__subheading">
                Walking is a decentralized finance platform that offers a
          ...
          <Fade up delay={100}>
            <div className="project__details__text__header__container__right">
              ...
              <div className="project__details__text__header__container__right__logo">
                <img src="/walkinglogo.webp" alt="logo" />
              </div>
            ...
            <Swiper spaceBetween={20} slidesPerView={swiperSlides}>
              ...
              <SwiperSlide>
                <div className="project__header__imags__slider__card">
                  <img src="/walking1.webp" alt="image" />
                </div>
              </SwiperSlide>
              <SwiperSlide>
                <div className="project__header__imags__slider__card">
                  <img src="/walking2.webp" alt="image" />
                </div>
              </SwiperSlide>
              <SwiperSlide>
                <div className="project__header__imags__slider__card">
        ...
        <div className="project__details__text__header__container__bg" style={{
            background: 'linear-gradient(120deg, #130032 3.95%, #da3667 96.98%)'
        }}/>
        ...
        <div className="project__main__full__img">
          <img src="/walkingvideo.webp" alt="devscot" />
        </div>
        <Fade up delay={100}>
          <div className="process__image">
            <img src="/walkingsvg.svg" alt="" />
          </div>
        </Fade>
        <div className="Emphasizing__main__container">
          <Fade up delay={100}>
            <div className="Emphasizing__main__container__logo">
              <img src="/walkinglogo.webp" alt="meal" />
            </div>
          </Fade>
          <Fade up delay={100}>
